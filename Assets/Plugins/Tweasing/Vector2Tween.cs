...
namespace Tweasing {
	...
	public class Vector2TweenProvider {
		...
		public Vector2Tween Generate(Vector2 tweenFrom, Vector2 tweenTo, Action<Vector2> onUpdated, Action<Unit> onCompleted=null) {
	...
	public class Vector2Tween : Tween<Vector2> {
		...
		public Vector2Tween (float duration, Vector2 tweenFrom, Vector2 tweenTo, EasingEnum easingType, Action<Vector2> onUpdated, Action<Unit> onCompleted=null)
